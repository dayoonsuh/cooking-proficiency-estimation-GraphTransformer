...
if __name__ == '__main__':
    ...
    parser.add_argument('--operator', type=str, default='graphconv', choices=['gcn', 'cheb', 'graphconv', 'gat', 'transformer'])
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--num_epochs', type=int, default=20) # default was 1
    ...
    parser.add_argument('--num_layers', type=int, default=8) #default was 2
    ...
    parser.add_argument('--dropout_transformers', type=float, default=0.0)
