...
class OutputBlock(nn.Module):
    ...
    def __init__(self, Ko, last_block_channel, channels, end_channel, n_vertex, act_func, bias, droprate):
        ...
        #self.fc2 = nn.Linear(in_features=channels[1], out_features=2, bias=bias)
    ...
    def forward(self, x):
        ...
        _, feat_dim, ts, n_joint = x.shape

        x = x.reshape(-1,feat_dim * ts * n_joint)
